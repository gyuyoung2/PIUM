...
public class Login extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(user!=null){
            ...
            intent.putExtra("profileUrl",String.valueOf(user.getPhotoUrl()));
            Toast.makeText(Login.this, Username+"님, 반갑습니다.", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createRequest();
        Username = String.valueOf(signInAccount.getDisplayName());
